        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" onclick="exportTableToExcel('dataTable','Listado por genero')"><i class="fas fa-download fa-sm text-white-50"></i> Exportar a EXCEL</a>
                </div>-->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Informaciones General del Participantes
