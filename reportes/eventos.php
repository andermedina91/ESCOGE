...
<head>
    ...
    <title>ESCOGE RD REPORTE EVENTOS </title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                -->
                    ...
                    <!-- INICIO CONTENEDOR -->
                    <div class="container-fluid">
                        <form method="POST" action="admin/eventos.php" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="title">Titulo de los Eventos: <small class="text-danger"><strong>*</strong></small></label>
                                <input type="text" class="form-control" name="title" id="title" required>
                            </div>

                            <div class="form-group">
                                <label for="description">Descripcion de los Eventos: <small class="text-danger"><strong>*</strong></small></label>
                                <textarea class="form-control" name="description" id="description" cols="30" rows="5"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="imagen">Cargar Imagen: <small class="text-danger"><strong>*</strong></small></label>
